    ...
    <nav class="side-navbar">
      <div class="side-navbar-inner">
        ...
        <div class="sidebar-header d-flex align-items-center justify-content-center p-3 mb-3">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img class="img-fluid rounded-circle avatar mb-3" src="{{ asset('../images/admin.png') }}" alt="person">
                    ...
                    <div class="card border-0 shadow">
                      <div class="card-body">
                        <form action="{{ ('/additem') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                          <input type="text" name="productName" id="" class="form-control my-4 py-2" placeholder="Item Name" />
                          <textarea name="description" id="" class="form-control my-4 py-2" placeholder="Description"></textarea>
                          <input type="number" name="price" id="" class="form-control my-4 py-2" placeholder="price" />
                          <select name="categori" id="cars"  class="form-control my-4 py-2">
                            <option value="phone">Phone</option>
                            <option value="watch">Watch</option>
                          </select>
                          <input type="file" name="image" id="" class="form-control my-4 py-2" placeholder="" />
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->categori}}</td>
                            <td><img src="{{ asset('../productImages/'.$data->tumbnail)}}" alt="" style="width:50px;height:50px"></td>
                            <td><a href="{{ route('updateview',$data->id) }}" class="btn btn-primary"><i class="fa fa-trash-o fa-lg"></i>Update</a></td>
                            <td><a href="{{ route('deleteproduct',$data->id) }}" class="btn btn-danger"><i class="fa fa-trash-o fa-lg"></i>Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
